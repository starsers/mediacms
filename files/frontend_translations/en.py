translation_strings = {
    ...
    "AI subtitle generation started": "AI subtitle generation started",
    ...
    "Enable Download": "",
    "Denoise": "Denoise",
    "Denoise processing started": "Denoise processing started",
    "Enter playlist name...": "",
    ...
    "Failed to archive media": "Failed to archive media",
    ...
    "Failed to start AI subtitle generation": "Failed to start AI subtitle generation",
    "Failed to start denoise processing": "Failed to start denoise processing",
