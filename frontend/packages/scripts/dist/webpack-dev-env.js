...
var backendTarget = process.env.MEDIACMS_BACKEND_URL || 'http://web:80';
var frontendPagePaths = new Set([
    '/',
    '/index',
    '/index.html',
    '/search',
...
var frontendAssetPattern = /\.(js|css|json|map|png|jpe?g|gif|svg|ico|webp|woff2?|ttf|eot)$/;
function shouldProxyToBackend(pathname, req) {
